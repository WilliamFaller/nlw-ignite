  ...
  return (
    <div className="max-w-[1344px] mx-auto flex flex-col items-center my-20">
      ...
      <h1 className="text-6xl text-white font-black mt-20 ">Seu <span className="bg-nlw-gradient bg-clip-text text-transparent">duo</span> está aqui.</h1>
        ...
        <div className="pt-1 bg-nlw-gradient self-stretch rounded-[10px] mt-8"> 
          <div className="bg-[#2A2634] px-8 py-6 rounded-b-lg flex justify-between items-center">
            ...
            <button className="text-white font-semibold py-3 px-4 bg-violet-500 rounded hover:bg-violet-600 flex items-center gap-3">
